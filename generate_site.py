...
OSP_BLOCKS = [
    ...
    },
    {
        ...
        "lessons": [
            ...
            ("lesson-11", "Tekoäly ja tietosuoja — valinta organisaation näkökulmasta", "teaching"),
            ...
            ("lesson-14", "Rakennuspalikka 2 — suunnittele botin määrittelydokumentti", "teaching"),
            ("lesson-15", "Rakennuspalikka 3 — kuratoi botin tietopohja", "teaching"),
