...
_DEMO_MOBILE_MODELS = {
    ...
    'lesson-06-01': ('compare', ['TEHTÄVÄ 1 · tarkka muutos: kaaviosta arvio, taulukosta tarkka +44,4 % → piste taulukolle',
                              ...
                              'Kumpikin muoto voitti kerran — muoto valitaan tehtävän mukaan',
                                 'Tarkista havainto lopuksi alkuperäisestä aineistosta']),
    'lesson-07-01': ('flow', ['Kielimalli esittää täsmällisen väitteen',
                              'Etsi väitteelle riippumaton ja ensisijainen lähde',
                              'Vertaa väitettä lähteen näyttöön',
                              'Lähde ei tue väitettä → älä käytä sitä',
                              'Ratkaisevaa on lähteen näyttö, ei mallin varma sävy']),
    'lesson-08-01': ('layers', ['Tekoälyn tulos', 'Data ja oikeudet — ketkä näkyvät aineistossa?',
                                'Ihmisten työ — millaisissa oloissa työ tehtiin?',
                                'Energia ja vesi — mitä käyttö kuluttaa?',
                                'Päätös ja vastuu — keneen tulos vaikuttaa?']),
    'lesson-10-01': ('flow', ['0 · PORTTI: saako aineistoa käyttää palvelussa ja täyttyvätkö pakolliset ehdot? Jos ei → ei pisteytetä',
                              '1 · LUKITSE kriteerit ennen katselua: sisältö, rakenne, kieli',
                              '2 · PISTEYTÄ sokkona: A 3/3 · B 1/3 (✗ rakenne: välivaiheet puuttuvat)',
                              '3 · PALJASTA vasta lopuksi: A oli uusi, B tuttu — näyttö ratkaisi, ei merkki']),
    'lesson-11-01': ('compare', ['AINEISTON LUONNE ensin: julkinen · sisäinen · henkilötieto · erityissuoja',
    ...
    'lesson-12-01': ('flow', ['Kriteerit lukitaan ennen ajoa → V1: kaksi täyttyy, yksi ei (keksityt määräajat)',
                              ...
                              'V2 samalla aineistolla: juuri se kriteeri kääntyy — muutos on todennäköinen selitys, yksi pari ei todista',
                                 'Toista koe toisella vastaavalla aineistolla']),
    'lesson-13-01': ('flow', ['POHJA: sinä annat tavoitteen ja lähdeaineiston, AI luonnostelee palautusohjeen',
                              'MUOKKAUS: painike → tilausvahvistuksen linkki (lähde) · lisäys: tuote käyttämätön (lähde)',
                              'TARKISTUS: selvennys hyväksytään (käyttäjän tarve), määräajan poisto hylätään (lähteessä)',
                              'PÄÄTÖS: ihminen päättää — loki näyttää jokaisen vaiheen tekijän ja perusteen']),
    'lesson-14-01': ('flow', ['Sumea idea → mittatikku: käyttäjä tarvitsee apua tehtävään, jotta lopputulos',
                              '”Auttaa hyvin?” hylätään → havaittava kriteeri: löytää hyväksytystä lähteestä ajan, varusteet ja seuraavan askeleen',
    ...
    'lesson-15-01': ('flow', ['KYSYMYS: käyttäjä kysyy jotain botilta',
                              'HAKUVAIHE (RAG): järjestelmä etsii tietopohjasta kysymykseen osuvimmat tekstikatkelmat',
                              'TEKSTIKATKELMAT: aineisto on pilkottu paloiksi — haku poimii osuvimmat, ei koko dokumenttia',
                              'KONTEKSTI: löydetyt katkelmat + kysymys annetaan kielimallille',
                              'VASTAUS: syntyy katkelmien pohjalta — jos osuvaa katkelmaa ei löydy, botti ei arvaa vaan kertoo, ettei tietoa löytynyt']),
    'lesson-16-01': ('loop', ['Sama sykli joka välineellä: tavoite → kriteerit → V1 → havainto → 1 muutos → V2 → vastuullisuustarkistus → julkaise tai hylkää',
                              ...
                              'VIDEO: tekstitys vaihtui liian nopeasti → kohtauksen kesto 7 sekuntiin · KOODI: tyhjä syöte kaatoi → virhetesti lisätty',
                              'Loki kerää havainnon ja muutoksen — väline vaihtuu, sykli ei']),
    'lesson-17-01': ('flow', ['Testattu promptikortti', 'Botin tarkoitus ja rajat', 'Hyväksytty tietopohja',
    ...
    'lesson-19-01': ('compare', ['CHATBOT: kertoo vaiheet tekstinä → työ jää käyttäjälle',
                                 'KURSSIN AGENTTI: kielimalli valitsee rajatun toiminnon → agentin ohjauskehys käyttää työkalua ja raportoi toiminnan']),
    'lesson-20-01': ('branch', ['SAMA TEHTÄVÄVIRTA — kolme toteutustapaa: promptaus · työnkulku · kurssilla rajattu agentti',
                                'RUTIINI: työnkulku riittää — promptauksessa ihmistyö toistuu, agentin rakennus ja valvonta maksavat',
                                'POIKKEUS: työnkulku jumittuu ilman sääntöä — harkitse agenttia, kun toistuva vaihtelu vaatii tilannepäättelyä, rajattuja työkaluja ja valvontaa',
    ...
    'lesson-21-01': ('layers', ['KONTEKSTI-IKKUNA rajaa sen, mitä malli voi käsitellä nyt',
                                'KESKUSTELUHISTORIASTA valitaan tehtävään olennainen osa kontekstiin',
                                'PROSESSIN TILA kertoo, missä vaiheessa työnkulku on',
                                'RAKENTEINEN PITKÄKESTOINEN TIETO säilyttää täsmälliset asiakas-, tilaus- ja tilatiedot',
                                'SEMANTTINEN VEKTORIHAKU löytää merkitykseltään samankaltaisia tekstikatkelmia',
                                'TIETOPOHJA JA RAG tuovat hyväksyttyä lähdetietoa kontekstiin käyttöoikeudet säilyttäen']),
    'lesson-22-01': ('flow', ['Käyttäjän kysymys tai tehtävä', 'Agentti tunnistaa tiedon tai toiminnon tarpeen',
                              'Ohjauskehys sallii vain rajatun työkalun ja oikeudet',
                              'Työkalu palauttaa tuloksen tai virheen', 'Agentti vastaa työkalun tuloksen perusteella']),
...
def annotate_demos(html, lid):
    ...
    def figure(match):
        ...
        interactive = ((lid == 'lesson-20' and counter == 2) or
