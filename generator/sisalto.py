...
_DEMO_MOBILE_MODELS = {
    ...
    'lesson-15-02': ('flow', ['KYSYMYS: käyttäjä kysyy jotain botilta',
    ...
    'lesson-20-01': ('branch', ['SAMA TEHTÄVÄVIRTA — kolme toteutustapaa: promptaus · työnkulku · agentti (= kielimalli + harness)',
