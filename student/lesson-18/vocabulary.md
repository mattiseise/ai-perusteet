# Tekoälyjen käyttö -osion sanasto

Tämä on yhteenvetosanasto "Tekoälyjen käyttö" -osiosta. Se sisältää tärkeimmät käsitteet, jotka opit oppitunneilla 10–18.
...
**Algoritmi**
Sarja askeleita tai sääntöjä, joita seuraamalla ratkaistaan ongelma tai tehdään jotain. Tekoälymallit noudattavat algoritmeja päätösten tekemiseen.
...
**Embedding**
Numeerinen esitys sanasta, lauseesta tai kuvasta. Tekoäly muuttaa tekstin numeroiksi, jotta se voi käsitellä sitä matemaattisesti. Samankaltaisilla teksteillä on samankaltaiset embeddit.

**Emergenssi**
Ilmiö, jossa tekoälyllä on odottamattomia kykyjä, joita ei nimenomaisesti opetettu. Esimerkiksi: tekoälyllä ei opetettu ratkaisemaan matemaattisia tehtäviä, mutta se osaa.
...
**Iteraatio**
Prosessi, jossa teet jotain, testat sen, korjaat ja teet uudelleen. Iteraatio on normaalia ohjelmistokehityksessä ja tekoälytyöskentelyssä. Iteratiivinen prosessi = useita kierroksia, kunnes se on hyvä.
...
**Konteksti (Context)**
Tausta-informaatio, jonka annat tekoälylle, jotta se voi ymmärtää kysymyksen paremmin. Esimerkiksi: jos käyt pitkän keskustelun, botti säilyttää kontekstia edellisistä viesteistä.

**Kontekstiikkuna (Context Window)**
...
**Malli (Model)**
Matemaattinen rakennelma, joka voidaan opettaa tekemään ennusteita tai tuottamaan tekstiä. Tekoäly on malli.

**Muisti (Memory)**
Tekoälyn kyky muistaa aiempia viestejä samassa keskustelussa. Jotkut botit unohtavat kaiken; jotkut muistavat kontekstia.
...
Laskennallinen rakennelma, joka jäljittelee aivojen neuroneja. Tekoälymallit rakennetaan neuroverkoista.

**Negatiivinen testi (Negative Test)**
Testaus, jossa yrität tehdä jotain, mitä botin ei pitäisi tehdä. Varmistetaan, että botti kieltäytyy asianmukaisesti.
...
**Validointi**
Prosessi, jossa tarkistetaan, että tekoälyn vastaus on oikea ja hyödyllinen. Manuaalinen validointi = ihminen tarkistaa; automaattinen validointi = ohjelma tarkistaa.

---

## Z

**Nolla-oppiminen (Zero-shot)**
Kun tekoälymalli vastaa kysymykseen ilman, että sitä on opetettu kysymyksen tyyppistä. Esimerkiksi: botti, joka osaa vastata mihin tahansa kysymykseen ilman erityisiä harjoituksia.

---

## Lisää resursseja

Jos haluat syventää tietojasi näistä käsitteistä, katso:
- OpenAI:n dokumentaatio: https://platform.openai.com/docs
- Tekoälyä koskevia artikkeleja: Mitä tarvitsee tietää
