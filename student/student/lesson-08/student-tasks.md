...
1. **Tutustu tositapaukseen:**
   ...
   - **OpenAI vs. kirjailijoiden yhdistys** (2023) — kirjailijoiden korvausvaatimus ChatGPT:n koulutuksesta
   - **Stability AI vs. kuvataiteilijat** (2023) — Midjourneyn ja Stable Diffusionin koulutus kuvataiteilijoiden teoksilla ilman lupaa
   - **Google vs. kirjoittajat** — Googlen koulutusdatan hankinnan laillisuus

2. **Tutki tapausta:**
   - Kuka on kantaja ja kuka vastapuoli?
   - Mitä väitettä kantaja esittää?
   - Mitä väitettä vastapuoli esittää?
...
## Tehtävä 3: Datan merkitsijät ja globaali työ

### Tavoite
Ymmärtää, mitä "näkymätöntä työtä" tekoälyn opetukseen liittyy ja mikä sen eettinen merkitys on.
...
2. **Dokumentoi löydöksesi:**
   ...
   |---|---|---|
   | Palkkaus | Kuinka paljon merkitsijät saavat? | |
   | Työn luonne | Mitä merkitsijät tekevät päivittäin? | |
   | Psyykkinen kuormitus | Mitkä haasteet heillä on? | |
   | Oikeudet | Onko heillä sopimuksia, vakuutuksia? | |

3. **Pohdi vastuuta:**
   - Kun käytät ChatGPT:tä, käytät mallia, jota nämä työntekijät ovat opettaneet.
   - Kuka on vastuussa heidän hyvinvoinnistaan? (OpenAI? Sinä? Molemmat?)
   - Pitäisikö merkitsijöille maksaa enemmän?
   - Pitäisikö heidän saada pääsy malleihin, joita he auttoivat rakentamaan?

4. **Kirjoita eettinen kannanotto (3–4 lausetta):**
   - Millä tavoin ammattilaisena ottaisit nämä näkökohdat huomioon käyttäessäsi tekoälyä käytännössä?

---

## Tehtävä 4: Ympäristövaikutukset ja energia

### Tavoite
Ymmärtää tekoälyn ympäristöjalanjälkeä ja harkinnan tarvetta sen käytössä.

### Ohjeet

1. **Etsi tietoja ChatGPT:n (tai muiden mallien) energiankulutuksesta:**
   - Kuinka paljon sähköä yksi query kuluttaa?
...
- Eettinen kannanotto, joka osoittaa ymmärrystä globaalista vastuusta

**Tehtävä 4:**
- Energia- ja vedenkulutuksen laskelmia
