# Tekoälyjen käyttö -osion lopputyö: Rakenna oma projektidokumenttibotti

Tämä on Tekoälyjen käyttö -osion arvioitava lopputyö. Rakennat itse suunnittelemasi **projektidokumenttibotin** Microsoft Copilot Agent -alustalle. Botti auttaa oman ammattialasi ammattilaista laatimaan projektin määrittelydokumentin. Et tee koko työtä yhdellä istumalla — keräät matkan varrella **kolme rakennuspalikkaa**, joista kasaat botin tunnilla 17 ja viimeistelet sen tunnilla 18.

> **Miksi näin?** Hyvää bottia ei rakenneta yhdellä tunnilla. Sen pohjana ovat kolme rakennuspalikkaa, jotka kerätään koko osion aikana — promptauspankki (tunti 12), määrittelydokumentti (tunti 14) ja kuratoituu tietopohja (tunti 15). Kun palikat ovat valmiina, tunneilla 17–18 voit keskittyä rakentamiseen, testaamiseen ja viimeistelyyn.
...
| **14** | Suunnittelet botin määrittelydokumentin | **Rakennuspalikka 2: Määrittelydokumentti** |
...
**Rakennuspalikka 2: Määrittelydokumentti (tunti 14)**
...
Linkki bottiin, jotta arvioija pääsee testaamaan sitä itse. Botti tunnistaa oman alasi termit ja ohjaa käyttäjää määrittelydokumentin osien läpi.

**2. Suunnitelmasi**
Tunnin 14 määrittelydokumentti (rakennuspalikka 2), päivitettynä lopputyösi botin mukaisesti.
...
**5. Testikeskustelu**
Vähintään yksi täysi keskustelu, jossa botti ohjaa kuvitellun projektin määrittelydokumentin laatimisessa alusta loppuun (kuvakaappaukset tai kopio).
...
**Yksin tai pareittain:** Lopputyö tehdään yksin, koska bottisi on sinun ammattialasi näköinen. Voit kuitenkin sparrata luokkakavereiden kanssa rakennuspalikoiden kokoamisessa.
...
|---|---|---|
| **Toimiva botti** | 25 p | Toimiiko botti? Ohjaako se käyttäjää järjestelmällisesti määrittelydokumentin osien läpi? |
| **Järjestelmäprompti** | 20 p | Onko järjestelmäpromptissa selkeä rooli, työnkulku ja rajat? Käyttääkö se oman alasi termejä? |
| **Tietopohja** | 20 p | Onko tietopohjassa 3–5 hyvää, perusteltua dokumenttia? Tukevatko ne botin tehtävää? |
| **Testaaminen ja iterointi** | 20 p | Onko bottia testattu oikealla projekti-idealla? Onko järjestelmäpromptia iteroitu vähintään kahdesti? |
...
- Suunnitelma (päivitetty määrittelydokumentti)
