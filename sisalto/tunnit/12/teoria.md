...
<figure class="ai-demo"><span class="ai-demo__tag">// sama koe — yksi nimetty muutos kerrallaan</span>
<div class="ai-demo__stage" style="display:flex;align-items:center;justify-content:center;height:312px">
  <div class="l12-wrap" role="img" aria-label="Promptikorttia parannetaan kontrolloidusti. Ensin kriteerit lukitaan ennen ajoa ja versio 1 arvioidaan: kaksi kriteeriä täyttyy, yksi ei — malli keksi määräaikoja. Sitten korttiin tehdään täsmälleen yksi nimetty muutos: älä keksi puuttuvia määräaikoja. Versio 2 ajetaan samalla aineistolla, ja juuri se kriteeri kääntyy hyväksytyksi. Ero voidaan lukea muutoksen ansioksi, koska vain yksi asia muuttui.">
    ...
    <span class="l12-res">ero ↔ muutos — tällä aineistolla</span>
  </div>
</div>
<figcaption class="ai-demo__cap">Vaikutuksen voi väittää vain, kun kriteerit lukittiin ennen ajoa ja vain yksi asia muuttui. Silloin V1:n ja V2:n eron voi lukea muutoksen ansioksi — tällä aineistolla, tässä kokeessa. Vie hiiri kuvan päälle pysäyttääksesi.</figcaption></figure>
<style>
.l12-wrap{position:relative;width:560px;height:296px;font-family:var(--font-mono);animation:l12w 21s infinite}
.l12-wrap:hover,.l12-wrap:hover *{animation-play-state:paused}
.l12-ph{display:block;font-style:normal;font-size:10.5px;font-weight:700;letter-spacing:.08em;color:#EAEEF8}
.l12-ph .l12-pre{color:#7FD0A8;animation:l12pre 21s infinite;display:inline-block}
...
.l12-ln{display:flex;align-items:center;gap:7px;margin-top:12px;font-size:10.5px;color:#B9C2DA}
...
.l12-ch b{position:absolute;left:0;top:0;width:100%;box-sizing:border-box;font-size:10.5px;line-height:1.25;font-weight:400}
.l12-old{color:#8B94B3;padding-top:6px;animation:l12old 21s infinite}
.l12-new{color:#0B0F1A;background:#C9B7F1;border-radius:7px;padding:4px 8px;font-weight:700;opacity:0;animation:l12new 21s infinite}
.l12-same{position:absolute;left:12px;bottom:30px;font-style:normal;font-size:10px;color:#7FD0A8;opacity:0;animation:l12same 21s infinite}
.l12-cnt{position:absolute;left:12px;bottom:8px;font-size:10.5px;font-weight:700;color:#C9B7F1;border:1px solid #C9B7F1;border-radius:999px;padding:2px 8px;opacity:0;animation:l12cnt 21s infinite}
...
.l12-hv b{width:26px;text-align:center;font-size:10.5px;color:#B9C2DA}
.l12-kr{position:relative;display:block;margin-top:14px;padding-right:76px;font-size:10.5px;line-height:1.3;color:#EAEEF8}
...
.l12-m.a1{animation:l12a1 21s infinite}.l12-m.a2{animation:l12a2 21s infinite}.l12-m.a3{animation:l12a3 21s infinite}
.l12-m.b1{animation:l12b1 21s infinite}.l12-m.b2{animation:l12b2 21s infinite}.l12-m.b3{animation:l12b3 21s infinite}
.l12-note{position:absolute;left:12px;bottom:8px;font-style:normal;font-size:10px;color:#FFD79A;opacity:0;animation:l12note 21s infinite}
.l12-data{position:absolute;left:60px;top:254px;font-size:10.5px;color:#06212A;background:#46C7CF;border-radius:999px;padding:3px 10px;opacity:0}
.l12-data.d1{animation:l12d1 21s infinite}
.l12-data.d2{animation:l12d2 21s infinite}
.l12-res{position:absolute;right:20px;top:256px;font-size:12px;font-weight:600;color:#FFD79A;opacity:0;animation:l12res 21s infinite}
@keyframes l12w{0%{opacity:0}3%{opacity:1}97%{opacity:1}100%{opacity:0}}
...
@media (prefers-reduced-motion:reduce){
  ...
  .l12-wrap,.l12-m,.l12-note,.l12-new,.l12-same,.l12-cnt,.l12-res{opacity:1}
  .l12-m{transform:scale(1)}
