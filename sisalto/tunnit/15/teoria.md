...
<figure class="ai-demo"><span class="ai-demo__tag">// maaliviiva ei siirry — sama vastaus, kaksi tuomiota</span>
<div class="ai-demo__stage" style="display:flex;align-items:center;justify-content:center;height:306px">
  <div class="l15-wrap" role="img" aria-label="Sama botin vastaus arvioidaan kahdella kaistalla. Ylhäällä odotus päätetään vasta vastauksen jälkeen: läpäisyehto siirtyy vastauksen luo ja kaikki näyttää läpäisevän — mittari siirtyi. Alhaalla läpäisyehto lukittiin ennen rakentamista: sama vastaus jää vajaaksi ja väliin paljastuu aukko. Vain ennalta lukittu odotus voi paljastaa aukon.">
    <div class="l15-lane la"><i class="l15-ph">A · ODOTUS PÄÄTETÄÄN VASTAUKSEN JÄLKEEN</i>
    ...
    <div class="l15-lane lb"><i class="l15-ph">B · ODOTUS LUKITTU ENNEN RAKENTAMISTA</i>
      <span class="l15-ans a2">botin vastaus</span>
      <i class="l15-gap"></i><em class="l15-gt">aukko</em>
      <i class="l15-ln fx"></i><span class="l15-lk">🔒</span><em class="l15-lkt">LUKITTU ENNEN</em>
      <span class="l15-vd vdb">ei läpi — aukko löytyi ✓</span></div>
    <span class="l15-ft">Sama vastaus — vain lukittu odotus paljastaa aukon</span>
  </div>
</div>
<figcaption class="ai-demo__cap">Läpäisyehto lukitaan ennen botin ensimmäistä vastausta. Jos kriteeri asetetaan vasta vastauksen jälkeen, se liukuu vastauksen kokoiseksi ja kaikki näyttää läpäisevän — vain kiinteä odotus paljastaa aukon. Hylkäys on tietoa, ei epäonnistumista. Vie hiiri kuvan päälle pysäyttääksesi.</figcaption></figure>
<style>
.l15-wrap{position:relative;width:560px;height:290px;font-family:var(--font-mono);animation:l15w 21s infinite}
.l15-wrap:hover,.l15-wrap:hover *{animation-play-state:paused}
.l15-ph{display:block;font-style:normal;font-size:10.5px;font-weight:700;letter-spacing:.06em;color:#EAEEF8}
...
.l15-ans{position:absolute;left:170px;top:44px;width:130px;box-sizing:border-box;text-align:center;font-size:11px;color:#0B0F1A;font-weight:700;background:#B9C2DA;border-radius:8px;padding:6px 0;opacity:0}
.l15-ans.a1{animation:l15ans 21s infinite}
.l15-ans.a2{animation:l15ans 21s infinite}
.l15-ln{position:absolute;top:30px;height:58px;width:0;border-left:2.5px dashed #C9B7F1}
.l15-ln.mv{left:418px;opacity:0;animation:l15mv 21s infinite}
.l15-ln.fx{left:418px;transform:scaleY(0);transform-origin:top;animation:l15fx 21s infinite}
.l15-gl{position:absolute;top:34px;height:50px;width:0;border-left:2px dashed #C9B7F1;opacity:0}
.l15-gl.g1{left:380px;animation:l15g1 21s infinite}
.l15-gl.g2{left:418px;animation:l15g2 21s infinite}
.l15-lk{position:absolute;left:426px;top:26px;font-size:12px;animation:l15lk 21s infinite}
.l15-lkt{position:absolute;left:444px;top:30px;font-style:normal;font-size:9.5px;font-weight:700;color:#7FD0A8;opacity:0;animation:l15lkt 21s infinite}
.l15-gap{position:absolute;left:302px;top:44px;width:114px;height:26px;background:repeating-linear-gradient(45deg,rgba(255,215,154,.35) 0 6px,transparent 6px 12px);border-radius:4px;transform:scaleX(0);transform-origin:left;animation:l15gap 21s infinite}
.l15-gt{position:absolute;left:340px;top:74px;font-style:normal;font-size:10px;color:#FFD79A;opacity:0;animation:l15gt 21s infinite}
.l15-vd{position:absolute;right:10px;top:8px;font-size:10.5px;font-weight:700;border-radius:7px;padding:3px 8px;opacity:0;white-space:nowrap}
.l15-vd.vda{color:#FFD79A;border:1.5px solid #FFD79A;background:rgba(255,215,154,.07);animation:l15vda 21s infinite}
.l15-vd.vdb{color:#46C7CF;border:1.5px solid #46C7CF;background:rgba(70,199,207,.07);animation:l15vdb 21s infinite}
.l15-conn{position:absolute;left:196px;top:110px;font-size:10px;color:#B9C2DA;border:1px dashed #4A5677;border-radius:6px;padding:1px 8px;opacity:0;animation:l15conn 21s infinite}
.l15-ft{position:absolute;left:0;top:252px;width:560px;text-align:center;font-size:12px;font-weight:600;color:#FFD79A;opacity:0;animation:l15ft 21s infinite}
@keyframes l15w{0%{opacity:0}3%{opacity:1}97.5%{opacity:1}100%{opacity:0}}
