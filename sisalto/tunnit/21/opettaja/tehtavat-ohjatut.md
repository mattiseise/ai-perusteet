...
## Aktiviteetti 1 — Nykyhetki, historia vai tila? (15 min)

Luokittele asiakaspalvelutapauksen tiedot:

- käyttäjän juuri lähettämä viesti → konteksti
- viime vuonna ratkaistu samankaltainen tapaus → pitkäkestoinen muisti
- hyvityspyyntö odottaa hyväksyntää → tila
- asiakkaan salasana → ei tallenneta

Käykää vastaukset läpi yksi kerrallaan. Jos ryhmä haluaa tallentaa tiedon ”varmuuden vuoksi”, kysy, missä tulevassa päätöksessä tietoa käytetään. Salasana toimii tarkoituksellisena rajatapauksena: kaikkea tehtävässä vastaan tulevaa tietoa ei saa muuttaa muistiksi.
...
- mitä käyttöoikeutta harness rajoittaa
- missä tarvitaan tarkistus tai ihmisen hyväksyntä

Päätä tehtävä vertaamalla ryhmien ratkaisuja. Järjestelmäprompti voi ilmaista tavoitteen, mutta arkaluonteisen tiedon käyttöoikeutta ei pidä jättää pelkän tekstiohjeen varaan. Hyvä vastaus kertoo, miten harness rajoittaa pääsyä tietoihin ja mitä tapahtuu, jos sääntöä ei voida varmistaa teknisesti.
