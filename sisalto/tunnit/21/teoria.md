...
<figure class="ai-demo"><span class="ai-demo__tag">// kolme muistia, yksi asiakaspyyntö — ikkuna, vektorikanta ja tila yhteispelissä</span>
<div class="ai-demo__stage" style="display:flex;align-items:center;justify-content:center;height:330px">
  <div class="l21-wrap" role="img" aria-label="Asiakaspalveluagentin yksi pyyntö näyttää kolmen muistin yhteispelin. Konteksti-ikkuna näkee vain viimeisimmät viestit — vanhin putoaa pois, kun uusi saapuu. Pitkäkestoisesta muistista eli vektoritietokannasta harness hakee merkityksen perusteella palan, joka tuodaan ikkunaan, vaikka sanat eroavat. Tila kantaa vaiheen ja yritysmäärän vaiheesta toiseen: ikkuna unohtaa, tila muistaa. Päätös syntyy kaikkien kolmen perusteella. Pysyvät periaatteet ovat sääntöjä, eivät muistoja.">
    ...
    <div class="l21-p pw"><i class="l21-ph">KONTEKSTI-IKKUNA</i>
      ...
      <span class="l21-c ok c6">muistista: ratkaisu B</span>
      <em class="l21-pd">pieni — vanhin putoaa</em>
      <span class="l21-ov o1">vanhin putoaa ulos ↓</span></div>
    <div class="l21-p pm"><i class="l21-ph phm">PITKÄKESTOINEN MUISTI</i>
      <span class="l21-k k1">muistilaiteongelma · B auttoi</span>
      <span class="l21-k k2">ostohistoria: 5 tilausta</span>
      <span class="l21-k k3">toimitusviive 2024</span>
      <em class="l21-pd">haku merkityksellä</em>
    ...
    <span class="l21-pr">🔒 PYSYVÄT PERIAATTEET — sääntöjä, eivät muistoja · esim. ”ei salasanoja muistiin”</span>
  </div>
</div>
<figcaption class="ai-demo__cap">Konteksti-ikkuna näkee vain viimeisimmät viestit, vektoritietokannasta haetaan merkityksen perusteella pala ikkunaan, ja tila kantaa vaiheen ja muuttujat eteenpäin — ikkuna unohtaa, tila muistaa. Päätös syntyy kolmen muistin yhteispelistä; pysyvät periaatteet eivät ole muistia. Vie hiiri kuvan päälle pysäyttääksesi.</figcaption></figure>
<style>
.l21-wrap{position:relative;width:560px;height:314px;font-family:var(--font-mono);animation:l21w 21s infinite}
.l21-wrap:hover,.l21-wrap:hover *{animation-play-state:paused}
.l21-hd{position:absolute;left:0;top:2px;font-size:11px;font-weight:700;letter-spacing:.06em;color:#EAEEF8}
.l21-fz{position:absolute;right:0;top:0;font-size:10px;font-weight:700;color:#06212A;background:#46C7CF;border-radius:999px;padding:3px 9px;opacity:0}
.l21-fz.f1{animation:l21f1 21s infinite}
.l21-fz.f2{animation:l21f2 21s infinite}
.l21-fz.f3{animation:l21f3 21s infinite}
.l21-p{position:absolute;top:26px;height:180px;box-sizing:border-box;background:#11182A;border:1px solid #2B3552;border-radius:12px;padding:7px 9px}
.l21-p.pw{left:0;width:178px;animation:l21dimw 21s infinite}
.l21-p.pm{left:190px;width:178px}
.l21-p.pt{left:380px;width:180px;animation:l21dimw 21s infinite}
.l21-ph{display:block;font-style:normal;font-size:10px;font-weight:700;letter-spacing:.05em;color:#B9C2DA}
.l21-ph.phm{color:#C9B7F1}.l21-ph.pht{color:#FFD79A}
.l21-pd{position:absolute;left:9px;bottom:6px;font-style:normal;font-size:9.5px;color:#8B94B3}
.l21-c{position:absolute;left:9px;width:160px;box-sizing:border-box;font-size:10px;line-height:1.2;color:#06212A;background:#9BD8DC;border-radius:6px;padding:4px 7px;opacity:0}
.l21-c.ok{background:#7FD0A8;font-weight:700}
.l21-c.c1{top:26px;animation:l21c1 21s infinite}
.l21-c.c2{top:54px;animation:l21c2 21s infinite}
.l21-c.c3{top:82px;animation:l21c3 21s infinite}
.l21-c.c4{top:110px;animation:l21c4 21s infinite}
.l21-c.c5{top:110px;animation:l21c5 21s infinite}
.l21-c.c6{top:110px;animation:l21c6 21s infinite}
.l21-ov{position:absolute;left:9px;bottom:20px;font-size:9.5px;font-weight:700;color:#FFD79A;opacity:0}
.l21-ov.o1{animation:l21o1 21s infinite}
.l21-k{position:absolute;left:9px;width:160px;box-sizing:border-box;font-size:10px;line-height:1.25;color:#EAEEF8;background:#0E1524;border:1px solid #2B3552;border-radius:8px;padding:6px 7px}
.l21-k.k1{top:28px;animation:l21k1 21s infinite}
.l21-k.k2{top:74px}
.l21-k.k3{top:112px}
.l21-sem{position:absolute;left:9px;bottom:22px;font-size:9.5px;font-weight:700;color:#C9B7F1;opacity:0;animation:l21sem 21s infinite}
.l21-r{display:block;margin-top:12px;font-size:10.5px;color:#B9C2DA}
.l21-vv{position:relative;display:inline-block;min-width:112px;text-decoration:none}
.l21-r b{position:relative;font-weight:700;color:#FFD79A}
.l21-r .l21-va{animation:l21va 21s infinite}
.l21-r .l21-vb{position:absolute;left:0;top:0;white-space:nowrap;opacity:0;animation:l21vb 21s infinite}
.l21-r .l21-ya{animation:l21ya 21s infinite;display:inline-block}
.l21-r .l21-yb{position:absolute;left:0;top:0;opacity:0;animation:l21yb 21s infinite;display:inline-block}
.l21-ct{position:absolute;left:9px;bottom:34px;font-size:9.5px;font-weight:700;color:#FFD79A;opacity:0;animation:l21ct 21s infinite}
.l21-q{position:absolute;left:120px;top:96px;font-size:10px;color:#0B0F1A;background:#46C7CF;border-radius:999px;padding:3px 8px;opacity:0;animation:l21q 21s infinite;white-space:nowrap}
.l21-ql{position:absolute;left:190px;top:78px;font-style:normal;font-size:9.5px;color:#8B94B3;opacity:0;animation:l21ql 21s infinite}
.l21-cv{position:absolute;top:206px;width:0;height:14px;border-left:2px solid #7E88A8;transform:scaleY(0);transform-origin:top}
.l21-cv.v1{left:88px;animation:l21v1 21s infinite}
.l21-cv.v2{left:278px;animation:l21v2 21s infinite}
.l21-cv.v3{left:468px;animation:l21v3 21s infinite}
.l21-dec{position:absolute;left:170px;top:224px;width:220px;box-sizing:border-box;text-align:center;font-size:11.5px;font-weight:700;color:#7FD0A8;border:1.5px solid #7FD0A8;border-radius:9px;padding:5px 8px 6px;background:rgba(127,208,168,.07);opacity:0;animation:l21dec 21s infinite}
.l21-dec em{display:block;font-style:normal;font-size:9.5px;font-weight:400;color:#B9C2DA;margin-top:2px}
.l21-pr{position:absolute;left:0;top:280px;width:560px;box-sizing:border-box;text-align:center;font-size:10px;color:#8B94B3;border:1.5px dashed #4A5677;border-radius:9px;padding:7px 8px}
@keyframes l21w{0%{opacity:0}3%{opacity:1}97.5%{opacity:1}100%{opacity:0}}
...
@keyframes l21c1{0%,2%{opacity:0;transform:none}5%{opacity:1}22%{opacity:1;transform:none}27%,100%{opacity:0;transform:translateY(96px)}}
@keyframes l21c2{0%,6%{opacity:0;transform:none}9%{opacity:1}23%{transform:none}27%{transform:translateY(-28px)}54%{opacity:1;transform:translateY(-28px)}59%,100%{opacity:0;transform:translateY(60px)}}
@keyframes l21c3{0%,10%{opacity:0;transform:none}13%{opacity:1}23%{transform:none}27%{transform:translateY(-28px)}55%{transform:translateY(-28px)}59%{transform:translateY(-56px)}85%{transform:translateY(-56px)}90%,100%{opacity:0;transform:translateY(30px)}}
@keyframes l21c4{0%,14%{opacity:0;transform:none}17%{opacity:1}23%{transform:none}27%{transform:translateY(-28px)}55%{transform:translateY(-28px)}59%{transform:translateY(-56px)}86%{transform:translateY(-56px)}90%,100%{opacity:1;transform:translateY(-84px)}}
@keyframes l21c5{0%,23%{opacity:0;transform:translateY(8px)}27%{opacity:1;transform:none}55%{transform:none}59%{transform:translateY(-28px)}86%{transform:translateY(-28px)}90%,100%{opacity:1;transform:translateY(-56px)}}
@keyframes l21c6{0%,55%{opacity:0;transform:translate(190px,-56px) scale(.85)}62%{opacity:1;transform:none}86%{transform:none}90%,100%{opacity:1;transform:translateY(-28px)}}
@keyframes l21o1{0%,23%{opacity:0}26%{opacity:1}33%{opacity:1}36%{opacity:0}86%{opacity:0}89%{opacity:1}95%{opacity:1}97.5%,100%{opacity:0}}
@keyframes l21q{0%,34%{opacity:0;transform:none}37%{opacity:1;transform:none}40%{transform:none}48%{opacity:1;transform:translate(120px,-40px) scale(.9)}52%,100%{opacity:0;transform:translate(120px,-40px)}}
@keyframes l21ql{0%,40%{opacity:0}43%{opacity:1}50%{opacity:1}53%,100%{opacity:0}}
@keyframes l21k1{0%,48%{border-color:#2B3552;box-shadow:none}53%{border-color:#C9B7F1;box-shadow:0 0 10px rgba(201,183,241,.6)}64%{border-color:#C9B7F1;box-shadow:0 0 6px rgba(201,183,241,.35)}100%{border-color:#C9B7F1;box-shadow:none}}
@keyframes l21sem{0%,50%{opacity:0}54%,100%{opacity:1}}
@keyframes l21dimw{0%,38%{opacity:1}42%{opacity:.55}50%{opacity:.55}54%,100%{opacity:1}}
...
@media (prefers-reduced-motion:reduce){
  ...
  .l21-wrap,.l21-sem,.l21-ct,.l21-dec,.l21-fz.f3,.l21-r .l21-vb,.l21-r .l21-yb{opacity:1}
  .l21-c.c4{opacity:1;transform:translateY(-84px)}
  .l21-c.c5{opacity:1;transform:translateY(-56px)}
  .l21-c.c6{opacity:1;transform:translateY(-28px)}
  .l21-c.c1,.l21-c.c2,.l21-c.c3,.l21-q,.l21-ql,.l21-ov,.l21-fz.f1,.l21-fz.f2,.l21-r .l21-va,.l21-r .l21-ya{opacity:0}
