...
<figure class="ai-demo"><span class="ai-demo__tag" id="l02m-t"><i aria-hidden="true">// </i>kertaus tunnilta 1 — sääntö vai opittu arvio?</span>
...
<style>
.l02r-wrap{position:relative;width:560px;height:198px;font-family:var(--font-mono);animation:l02rw 7s 1 forwards}
...
.l02r-case{display:block;margin-top:7px;font-size:11px;color:#0B0F1A;background:#46C7CF;border-radius:999px;padding:3px 10px;width:fit-content;opacity:0;animation:l02rcase 7s 1 forwards}
.l02r-res{display:block;margin-top:6px;font-size:11.5px;font-weight:700;color:#7FD0A8;opacity:0;animation:l02rres 7s 1 forwards}
...
.l02r-mdl{margin-left:6px;font-size:11px;color:#EAEEF8;border:1.5px solid #C9B7F1;border-radius:8px;padding:4px 9px;animation:l02rmdl 7s 1 forwards}
.l02r-arr{color:#7E88A8;font-size:12px}
.l02r-out{font-size:10.5px;font-weight:700;color:#FFD79A;white-space:nowrap;opacity:0;animation:l02rout 7s 1 forwards}
...
<figure class="ai-demo"><span class="ai-demo__tag" id="l02r-t"><i aria-hidden="true">// </i>viisi käsitettä tekoälyn kartalla — kolme käytössä nyt, kaksi tulevaisuuspuhetta</span>
...
<style>
.l02m-wrap{position:relative;width:560px;height:300px;font-family:var(--font-mono);animation:l02mw 21s 1 forwards}
.l02m-gh{position:absolute;top:0;font-size:11px;font-weight:700;letter-spacing:.14em;opacity:0;animation:l02mp 21s 1 forwards}
.l02m-gh.g1{left:14px;color:#7FD0A8}.l02m-gh.g2{left:374px;color:#C9B7F1}
.l02m-pan{position:absolute;top:22px;height:218px;border-radius:12px;opacity:0;animation:l02mp 21s 1 forwards}
...
.l02m-bnd{position:absolute;left:347px;top:22px;height:218px;width:0;border-left:2px dashed #7E88A8;transform:scaleY(0);transform-origin:top;animation:l02mb 21s 1 forwards}
.l02m-bfl{position:absolute;left:342px;top:22px;height:218px;width:12px;background:radial-gradient(50% 50% at 50% 50%,rgba(255,215,154,.55),transparent);opacity:0;animation:l02mfl 21s 1 forwards}
.l02m-bl{position:absolute;left:198px;top:244px;width:300px;text-align:center;font-size:10.5px;color:#7E88A8;opacity:0;animation:l02mbl 21s 1 forwards}
...
.l02m-card em{display:block;font-style:normal;font-size:10px;line-height:1.25;color:#C9B7F1;margin-top:4px;opacity:0;animation:l02mtag 21s 1 forwards}
.l02m-card.c1{left:14px;top:44px;width:150px;height:62px;animation:l02mc1 21s 1 forwards}
.l02m-card.c2{left:14px;top:120px;width:150px;height:62px;animation:l02mc2 21s 1 forwards}
.l02m-card.c3{left:172px;top:120px;width:150px;height:62px;animation:l02mc3 21s 1 forwards}
.l02m-card.c4{left:374px;top:44px;width:172px;height:84px;border-style:dashed;border-color:#7E88A8;animation:l02mc4 21s 1 forwards}
.l02m-card.c5{left:374px;top:142px;width:172px;height:84px;border-style:dashed;border-color:#7E88A8;animation:l02mc5 21s 1 forwards}
.l02m-in{animation:none}
.l02m-in.ika{animation:l02mika 21s 1 forwards}
.l02m-in.ige{animation:l02mige 21s 1 forwards}
.l02m-ov{position:absolute;left:14px;top:188px;width:308px;text-align:center;font-size:10.5px;color:#7FD0A8;opacity:0;animation:l02mov 21s 1 forwards}
.l02m-bub{position:absolute;left:168px;top:82px;padding:4px 10px;border-radius:999px;background:#0E2A31;border:1px solid #46C7CF;color:#46C7CF;font-size:11px;white-space:nowrap;opacity:0;animation:l02mbub 21s 1 forwards}
.l02m-st{position:absolute;left:238px;top:28px;opacity:0;animation:l02mst 21s 1 forwards}
.l02m-st i{display:inline-block;font-style:normal;font-size:11px;font-weight:700;color:#FFD79A;border:1.5px solid #FFD79A;border-radius:6px;padding:3px 8px;background:rgba(255,215,154,.08);transform:rotate(-6deg);animation:l02mps 21s 1 forwards}
.l02m-syn{position:absolute;left:0;top:268px;width:560px;text-align:center;font-size:12px;font-weight:600;color:#FFD79A;opacity:0;animation:l02msyn 21s 1 forwards}
