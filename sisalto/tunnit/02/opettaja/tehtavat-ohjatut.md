...
Seuraavat tehtävät ovat vaihtoehtoja eivätkä muodosta yhtä peräkkäin suoritettavaa 70 minuutin kokonaisuutta. Tehtävä 2.1 korvaa tuntisuunnitelman 0–25 minuutin virittäytymis- ja nykyjärjestelmäosuuden. Pakollinen vertailutaulukko tehdään silti tuntisuunnitelman 50–70 minuutin kohdalla. Tehtävä 2.2 tai 2.3 korvaa 70–82 minuutin väitteenpurun. Näin yhdellä 90 minuutin tunnilla tehdään yksi ydintoiminto ja korkeintaan yksi väitteenpurku.

- **Perusreitti:** tehtävä 2.1 ja lyhyt purku tehtävästä 2.2.
- **Soveltava reitti:** tehtävä 2.1 ja tehtävä 2.3.
- **Itsenäinen reitti:** Harjoittele-välilehden tehtävät ja opiskelijan oma vertailutaulukko; opettajavetoisia tehtäviä ei tarvita.

## Tehtävä 2.1: Viisi käsitettä — korttilajittelu
...
## Tehtävä 2.2: Sama suoritus, liian suuri johtopäätös
...
## Tehtävä 2.3: Tekoälyväitteen purkaminen
