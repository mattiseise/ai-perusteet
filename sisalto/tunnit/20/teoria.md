...
<figure class="ai-demo"><span class="ai-demo__tag">// kolme välinettä, sama tehtävävirta — vaihtelu ratkaisee valinnan</span>
<div class="ai-demo__stage" style="display:flex;align-items:center;justify-content:center;height:312px">
  <div class="l20-wrap" role="img" aria-label="Kolme automatisoinnin välinettä käsittelee samaa tehtävävirtaa. Rutiiniviesteillä kaikki onnistuvat: promptaus vaatii sinut joka kertaan, työnkulku on nopein ja halvin, agentti onnistuu mutta maksaa eniten — rutiiniin työnkulku riittää. Poikkeavassa tapauksessa työnkulku jumittuu ilman sääntöä, promptauksessa selvität itse ja agentti arvioi tilanteen ja ratkaisee tai ohjaa ihmiselle — vaihteluun agentti kannattaa. Monimutkaisempi ei ole automaattisesti parempi.">
    <span class="l20-hd">KOLME VÄLINETTÄ — SAMA TEHTÄVÄVIRTA</span>
    <span class="l20-in ia">saapuu: rutiiniviesti ×3</span>
    <span class="l20-in ib">saapuu: poikkeava tapaus</span>
    <div class="l20-ln p1"><b class="l20-nm">PROMPTAUS</b><span class="l20-pip">€</span>
    ...
    <div class="l20-ln p2"><b class="l20-nm">TYÖNKULKU</b><span class="l20-pip">€€</span>
    ...
    <div class="l20-ln p3"><b class="l20-nm">AGENTTI</b><span class="l20-pip pa">€€€</span>
    ...
    <span class="l20-vd vb">vaihtelu → agentti kannattaa</span>
    <span class="l20-ts">monimutkaisempi ≠ parempi</span>
  </div>
</div>
<figcaption class="ai-demo__cap">Sama tehtävävirta, kolme välinettä: rutiinissa työnkulku on nopein ja halvin, promptaus sitoo sinut joka kertaan ja agentin jokainen ajo maksaa. Poikkeus kääntää asetelman — sääntö loppuu, agentti arvioi. Väline valitaan tehtävävirran vaihtelun mukaan. Vie hiiri kuvan päälle pysäyttääksesi.</figcaption></figure>
<style>
.l20-wrap{position:relative;width:560px;height:298px;font-family:var(--font-mono);animation:l20w 14s infinite}
.l20-wrap:hover,.l20-wrap:hover *{animation-play-state:paused}
.l20-hd{position:absolute;left:0;top:2px;font-size:11px;font-weight:700;letter-spacing:.07em;color:#EAEEF8}
.l20-in{position:absolute;right:0;top:0;font-size:10.5px;font-weight:700;border-radius:999px;padding:3px 10px;opacity:0}
.l20-in.ia{color:#06212A;background:#46C7CF;animation:l20ia 14s infinite}
.l20-in.ib{color:#0B0F1A;background:#FFD79A;animation:l20ib 14s infinite}
.l20-ln{position:absolute;left:0;width:560px;height:74px;box-sizing:border-box;background:#11182A;border:1px solid #2B3552;border-radius:12px;padding:7px 10px}
.l20-ln.p1{top:28px}.l20-ln.p2{top:108px}.l20-ln.p3{top:188px;border-color:#3D6b6e}
.l20-nm{display:block;font-size:12px;color:#EAEEF8}
.l20-pip{position:absolute;left:10px;top:26px;font-size:10.5px;letter-spacing:.12em;color:#FFD79A}
.l20-pip.pa{animation:l20pip 14s infinite}
.l20-ds{position:absolute;left:10px;bottom:6px;font-style:normal;font-size:10px;color:#8B94B3}
.l20-tok{position:absolute;left:150px;top:26px;width:13px;height:13px;border-radius:50%;background:#46C7CF;opacity:0}
.l20-tok.tp{animation:l20tp 14s infinite}
.l20-tok.tw{animation:l20tw 14s infinite}
.l20-tok.ta{animation:l20ta 14s infinite}
.l20-hand{position:absolute;left:216px;top:20px;font-size:10.5px;color:#EAEEF8;border:1px solid #4A5677;border-radius:7px;padding:3px 7px;background:#0E1524;animation:l20hand 14s infinite}
.l20-gate{position:absolute;left:250px;top:14px;width:0;height:38px;border-left:3px double #7E88A8}
.l20-th{position:absolute;left:216px;top:22px;font-size:10.5px;color:#C9B7F1;opacity:0;animation:l20th 14s infinite}
.l20-br{position:absolute;left:284px;top:22px;font-size:10px;color:#7FD0A8;opacity:0;animation:l20br 14s infinite}
.l20-wx{position:absolute;left:284px;top:22px;font-size:10px;font-weight:700;color:#FFD79A;opacity:0;animation:l20wx 14s infinite}
.l20-tl{position:absolute;right:10px;top:24px;display:flex;gap:7px}
...
.l20-m.pm1{animation:l20s1 14s infinite}.l20-m.pm2{animation:l20s2 14s infinite}.l20-m.pm3{animation:l20s3 14s infinite}.l20-m.pm4{animation:l20p4 14s infinite}
.l20-m.wm1{animation:l20s1 14s infinite}.l20-m.wm2{animation:l20s2 14s infinite}.l20-m.wm3{animation:l20s3 14s infinite}.l20-m.wm4{animation:l20x4 14s infinite}
.l20-m.am1{animation:l20s1 14s infinite}.l20-m.am2{animation:l20s2 14s infinite}.l20-m.am3{animation:l20s3 14s infinite}.l20-m.am4{animation:l20a4 14s infinite}
.l20-vd{position:absolute;top:272px;font-size:10.5px;font-weight:700;border-radius:7px;padding:3px 9px;opacity:0}
.l20-vd.va{left:0;color:#7FD0A8;border:1.5px solid #7FD0A8;background:rgba(127,208,168,.07);animation:l20va 14s infinite}
.l20-vd.vb{left:196px;color:#C9B7F1;border:1.5px solid #C9B7F1;background:rgba(201,183,241,.07);animation:l20vb 14s infinite}
.l20-ts{position:absolute;right:0;top:276px;font-size:11px;font-weight:600;color:#FFD79A}
@keyframes l20w{0%{opacity:0}3%{opacity:1}97%{opacity:1}100%{opacity:0}}
...
@keyframes l20pip{0%,22%{opacity:1}23.5%{opacity:.3}25%{opacity:1}72%{opacity:1}73.5%{opacity:.3}75%,100%{opacity:1}}
...
@media (prefers-reduced-motion:reduce){
  ...
  .l20-wrap,.l20-m,.l20-vd,.l20-in.ib,.l20-wx,.l20-br{opacity:1}
