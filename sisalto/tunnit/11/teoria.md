  ...
  <div class="l11-wrap" data-once role="img" aria-labelledby="l11-t" aria-describedby="l11-d">
    ...
    <div class="l11-dev"><i class="l11-ph">SINUN LAITTEESI</i>
      ...
      <div class="l11-loc"><i class="l11-ph phl">PAIKALLINEN AJO</i>
        ...
        <span class="l11-lw">tarkista: yhteydet, telemetria, päivitykset</span>
        <b class="l11-dc dc3">päätös: käytä tarkistusten jälkeen</b></div></div>
    ...
    <div class="l11-tp t1"><i class="l11-ph phc">YLEINEN PILVIPALVELU</i>
      ...
      <em class="l11-tb b1">» tarkista ehdot ja asetukset</em>
      <b class="l11-dc dc1">päätös: älä käytä ilman ehtojen tarkistusta</b></div>
    <div class="l11-tp t2"><i class="l11-ph pho">ORGANISAATION PALVELU</i>
      ...
      <em class="l11-tb b2">» sopimus ja ohjeet määrittävät</em>
      <b class="l11-dc dc2">päätös: käytä rajatusti sopimuksen mukaan</b></div>
...
<figcaption class="ai-demo__cap">Käyttöpäätös luetaan kolmesta asiasta yhdessä: aineiston luonteesta, datan reitistä ja palvelun ehdoista — ja lopputulos on päätös: käytä, käytä rajatusti tai älä käytä. Pilvessä kopio voi säilyä vastauksen jälkeenkin, organisaation palvelussa sopimus määrittää — ja paikallisessakin ajossa aineisto pysyy laitteella vain, jos työkalu ei lähetä sitä ulos.</figcaption></figure>
<style>
.l11-wrap{position:relative;width:560px;height:388px;font-family:var(--font-mono);animation:l11w 21s 1 forwards}
...
.l11-dev{position:absolute;left:2px;top:34px;width:206px;height:312px;box-sizing:border-box;background:#11182A;border:1px solid #2B3552;border-radius:12px;padding:9px 11px}
...
.l11-loc{position:absolute;left:10px;bottom:10px;width:184px;height:170px;box-sizing:border-box;border:1.5px solid #7FD0A8;border-radius:10px;padding:8px 9px;background:#0E1524}
...
.l11-bnd{position:absolute;left:236px;top:34px;height:312px;width:0;border-left:2px dashed #7E88A8}
.l11-bfl{position:absolute;left:230px;top:34px;height:312px;width:12px;background:radial-gradient(50% 50% at 50% 50%,rgba(255,215,154,.5),transparent);opacity:0}
.l11-bfl.f1{animation:l11f1 21s 1 forwards}
.l11-bfl.f2{animation:l11f2 21s 1 forwards}
.l11-bl{position:absolute;left:180px;top:350px;width:112px;text-align:center;font-size:12px;color:#B9C2DA}
.l11-tp{position:absolute;left:262px;width:296px;height:152px;box-sizing:border-box;background:#11182A;border-radius:12px;padding:9px 11px}
.l11-tp.t1{top:34px;border:1.5px solid rgba(255,215,154,.55)}
.l11-tp.t2{top:192px;border:1.5px solid rgba(201,183,241,.55)}
...
.l11-dc{display:block;margin-top:6px;font-size:12px;line-height:1.25;font-weight:700;opacity:0}
.l11-dc.dc1{color:#FFD79A;animation:l11dc 21s 1 forwards}
.l11-dc.dc2{color:#C9B7F1;animation:l11dc 21s 1 forwards}
.l11-dc.dc3{color:#7FD0A8;animation:l11dc 21s 1 forwards}
.l11-syn{position:absolute;left:0;top:368px;width:560px;text-align:center;font-size:12.5px;font-weight:600;color:#FFD79A;opacity:0;animation:l11syn 21s 1 forwards}
...
@keyframes l11dc{0%,90%{opacity:0}94%,100%{opacity:1}}
@media (prefers-reduced-motion:reduce){
  .l11-wrap,.l11-wrap *{animation:none!important}
  .l11-wrap,.l11-tl,.l11-tb,.l11-ll,.l11-lw,.l11-syn,.l11-dc{opacity:1}
  .l11-gh{opacity:.55}
  .l11-mv{opacity:0}
}
</style>
