# Tuomaripöydän päätös — asiantuntijalausunto
...
- **Todistusaineisto 3** (oppitunti 7, luotettavuusarvio ja tarkistuskäytäntö) auttaa erottamaan kielimallin väitteen tarkistamisen luokittelumallin virheistä sekä perustelemaan mittarin, tarkistusrajan ja ihmisen vastuun.
...
- **Yhden sivun tilannekartta:** Jaa sivu neljään kenttään: mitä tapahtui, miksi se tapahtui, miten tilanne hoidetaan ja miten vastuu jakautuu. Käytä avainsanoja, lyhyitä lauseita ja tarvittaessa nuolia. Merkitse karttaan kaikki kolme todistusaineistoa sekä lähteet niitä väitteitä tukemaan, joissa käytät niitä.
- **Kevyt päätöspuu:** Tee kolme päätöskohtaa, joissa kussakin on kaksi haaraa. Päätöskohdat voivat koskea näytön riittävyyttä, haitan vakavuutta ja ihmisen toimia. Nimeä jokaisen päätepisteen toiminta ja siitä vastaava rooli.
- **Suullinen esitys** (5–8 min, nauhoite tai suora esitys): Käytä karttaa ja päätöspuuta puheesi tukena. Selitä käsitteet, lähteisiin perustuvat johtopäätökset, suositus ja yksi merkittävä korjaus. Esitys toimii samalla puolustuksena.
...
- kirjallinen asiantuntijalausunto, 500–700 sanaa, tai yhden sivun tilannekartta, kevyt päätöspuu ja 5–8 minuutin esitys
- kaikki kolme todistusaineistoa liitteinä tai selkeästi tuotokseen sisällytettyinä
- lähdeluettelo
- käyttämäsi prompti tai keskustelulokin olennainen osa sekä mallin luonnos tai katkelma
- kaksi ennen–jälkeen-korjausta perusteluineen
- kirjallisella reitillä tunnin lopussa tehty tai nauhoitettu 1–2 minuutin puolustus opettajan ohjeen mukaan.
