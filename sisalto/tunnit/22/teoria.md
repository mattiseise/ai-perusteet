...
<svg viewBox="0 0 920 410" xmlns="http://www.w3.org/2000/svg" style="width:100%;max-width:840px;height:auto" font-family="system-ui, -apple-system, 'Segoe UI', sans-serif" role="img">
  ...
  <desc>n8n-solmuketju: viesti saapuu, kielimalli tulkitsee sen ja valitsee rajatun työkalun, vastaus muotoillaan ja tallennetaan taulukkoon.</desc>
  <defs>
  ...
  <use href="#ex-sheet" x="496" y="248" width="18" height="18" style="color:#3B5BDB"/><text x="520" y="261" font-size="11.5" font-weight="600" fill="#1B2336">Taulukko</text>
  ...
  <text x="90" y="356" font-size="11.5" fill="#3A4253">Kielimalli tulkitsee tilanteen ja valitsee sallitun työkalun.</text>
</svg>
...
- [n8n:n virallinen dokumentaatio](https://docs.n8n.io/)
- [OpenAI Platform: Developer quickstart ja Agent Builder](https://platform.openai.com/docs/quickstart)
- [Claude Platform: Managed Agents -aloitus](https://platform.claude.com/docs/en/managed-agents/quickstart)
- [Claude Platform: agentin määritys](https://platform.claude.com/docs/en/managed-agents/agent-setup)
