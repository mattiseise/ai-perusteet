...
- **Diat** — tunnin diakannet esitystilassa (ks. Diat ja lataamo).
...
Kurssilla arvioidaan **kolme lopputyötä**, yksi per moduuli. Jokaisesta voi saada 100 pistettä, ja pisteet jakautuvat viiteen kriteeriin painotuksella 25/20/20/20/15. Alla tiivistelmä; **täydet arviointikriteerit, rubriikit ja opettajan arviointiohjeet löydät koostettuna sivulta `/opettaja/arviointi/`.**
...
Arviointitunnit **18** ja **27** ovat kummankin moduulin summatiiviset arvioinnit, ja niiden opettajan tuntisivut sisältävät tarkemmat arviointiohjeet ja rubriikit. Tekoälyjen käyttö- ja Agentit-osioiden lopputyöt on rakennettu **vaikeasti tekoälyllä oikaistaviksi**: ne vaativat todellisia prompteja, tuloksia ja prosessin dokumentointia, joita ei voi keksiä jälkikäteen. Tunnin 18 arviointiohjeessa on punaisten lippujen lista tämän tunnistamiseen; tunnin 27 tuntisuunnitelmassa on vastaava LLM-resistenssin varmistamisen osio — vertaisarviointi ja suullinen demo paljastavat, ymmärtääkö opiskelija rakentamansa.
